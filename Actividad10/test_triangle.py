...
class TestAreaOfTriangle(TestCase):
    ...
    def test_float_values(self):
        ...
        self.assertAlmostEqual(
            area_of_a_triangle(3.4556, 8.3567), 14.43870626
        )
        self.assertEqual(
            area_of_a_triangle(2.3, 5.7), 6.555
        )
    ...
    def test_with_boolean(self):
        ...
        self.assertRaises(
            TypeError, area_of_a_triangle, True, 5
        )  # prueba con booleanos
        self.assertRaises(
            TypeError, area_of_a_triangle, 2, True
        )

    def test_with_string(self):
        """Prueba que se lance TypeError con tipos string"""
        self.assertRaises(
            TypeError, area_of_a_triangle, "base", 5
        )  # prueba con strings
        self.assertRaises(
            TypeError, area_of_a_triangle, 2, "altura"
        )

    def test_with_nulls(self):
        """Prueba que se lance TypeError con tipos nulos"""
        self.assertRaises(
            TypeError, area_of_a_triangle, None, 5
        )  # prueba con nulos
        self.assertRaises(
            TypeError, area_of_a_triangle, 2, None
        )
